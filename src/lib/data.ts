...
export const data: Product[] = [
    {
        ...
        "slug": slugify("Introduction to Agile Methodology").toLowerCase(),
    ...
    },
    {
        ...
        "slug": slugify("Understanding Version Control with Git").toLowerCase(),
    ...
    },
    {
        ...
        "slug": slugify("The Importance of Code Reviews").toLowerCase(),
